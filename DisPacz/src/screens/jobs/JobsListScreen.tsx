...
import { fetchJobs } from '../../api/disPaczApi';
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Scheduled field visits & repairs</Text>
      </View>
      <FlatList
        data={jobs}
        ...
        ListEmptyComponent={
          <Text style={styles.empty}>No jobs yet. Create some in the API or admin tools.</Text>
        }
        renderItem={({ item }) => (
          <JobCard
            job={item}
