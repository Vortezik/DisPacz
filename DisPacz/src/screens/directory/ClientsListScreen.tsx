...
import { fetchClients } from '../../api/disPaczApi';
...
type Nav = NativeStackNavigationProp<DirectoryStackParamList, 'ClientsList'>;

type Props = { navigation: Nav };

const ClientsListScreen: React.FC<Props> = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']}>
      <View style={styles.header}>
        ...
        <Text style={styles.subtitle}>Organizations you support in the field</Text>
      </View>
      <FlatList
        data={rows}
